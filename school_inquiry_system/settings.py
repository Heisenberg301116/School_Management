...
SECRET_KEY = 'c4^!-5ex8dm^m_f_4dwizn9i)!tzjc@!v@8*4pa!l&h4na7^lq'
...
ROOT_URLCONF = 'school_inquiry_system.urls'
...
WSGI_APPLICATION = 'school_inquiry_system.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'uncertain30@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'sbda lpld qrqw przf'  # Your email account's app-specific password
